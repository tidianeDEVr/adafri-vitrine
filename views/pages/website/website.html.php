...
<section class="blue-card-section">
    <div class="container text-center py-5">
        <h2 class="mt-3">Lancez une pub digitale comme un pro</h2>
        <p class="my-4">
            Notre plateforme vous aide à atteindre vos objectifs de<br>
            notoriété et/ou de conversion.Nous avons simplifié<br>
