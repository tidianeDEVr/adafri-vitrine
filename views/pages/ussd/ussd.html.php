<!-- Meta Tags  -->
<title>Sondage de masse | USSD | Adafri</title>
        ...
        <div class="row">
            <div class="col text-start order-2">
                <div class="d-flex flex-column justify-content-center h-100">
                    <h3>Fini les focus group, acceptez l’USSD pour de la masse</h3>
                    <p class="mt-2">
                        Il s’agit pour nous d’un outil puissant de capture pour des sondages à grande échelle à travers un parcours de questions/réponses.
                    </p>
                    <div class="mt-2">
