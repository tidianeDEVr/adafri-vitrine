...
?>
      <div class="container">
      <h1 class="text-center alert alert-dark">AJOUTER AC OU RP</h1>
      <form action="<?php ROOT_CONTROLLERS.'/security.php' ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="role" id="">
                <option value="ROLE_RESPONSABLE_PEDAGOGIQUE">Responsable pedagogique</option>
                <option value="ROLE_ASSISTANT_DE_CLASSE">Assistant de classe</option>
              </select>
            </div>
            <div class="mb-3">
